...
lol = Instance.new("ImageButton")




function randomString()
	local length = math.random(0,0)
	local array = {}
	for i = 1, length do
		array[i] = string.char(math.random(5, 9))
	end
...
lol.Parent = PARENT
lol.Active = true
lol.BackgroundColor3 = Color3.fromRGB(36, 36, 37)
lol.BorderSizePixel = 0
lol.Position = UDim2.new(0, 0.99, 0, 0.99)
lol.Size = UDim2.new(0, 10, 0, 10)
lol.ZIndex = 10
...
Logo.Image = "rbxassetid://15115110089"
...
ColorsButton.MouseButton1Click:Connect(function()
	...
	if not colorpickerOpen then
		...
		Npicker.Default = function(self)
			updateColors(Color3.fromRGB(134, 45, 203),shade1)
			updateColors(Color3.fromRGB(134, 45, 203),shade2)
			updateColors(Color3.fromRGB(134, 45, 203),shade3)
			updateColors(Color3.new(1, 1, 1),text1)
			updateColors(Color3.new(0, 0, 0),text2)
			updateColors(Color3.fromRGB(134, 45, 203),scroll)
			wait()
			updatesaves()
		end
	else
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'EvonFPS', DESC = 'this command show your FPS!.'}
CMDs[#CMDs + 1] = {NAME = 'UnEvonFPS', DESC = 'this command destroy FPS UI.'}

CMDs[#CMDs + 1] = {NAME = 'discord sever invite', DESC = 'Invite to the Evon server.'}
...
CMDs[#CMDs + 1] = {NAME = 'fly [speed] Fixed for mobile', DESC = 'FLy Fixed for mobile!'}
...
addcmd('EvonFPS', {'FPS'}, function(args, speaker)
repeat wait() until game:IsLoaded() wait(2)
local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "EvonFPS"
...
Fps.BackgroundColor3 = Color3.fromRGB(50, 15, 100)
...
Ping.BackgroundColor3 = Color3.fromRGB(50, 15, 100)
...
addcmd('UnEvonFPS',{'UnFPS'},function(args, speaker)
game.CoreGui.EvonFPS:Destroy()
end)

addcmd('discord', {'support', 'help'}, function(args, speaker)
	if toClipboard then
		toClipboard('https://discord.gg/evon')
		notify('Discord Invite', 'Copied to clipboard!\nhttps://discord.gg/evon')
	else
		notify('Discord Invite', 'https://discord.gg/evon')
	end
	if httprequest then
		httprequest({
...
task.spawn(function()
	...
	TweenService:Create(Logo, OutInfo, {ImageTransparency = 0.7}):Play()
	TweenService:Create(IntroBackground, OutInfo, {BackgroundTransparency = 1}):Play()
	TweenService:Create(Credits, OutInfo, {TextTransparency = 0.7}):Play()
	wait(0.2)
	minimizeHolder()
...
Holder.BackgroundColor3 = Color3.fromRGB(50, 15, 100)
Title.BackgroundColor3 = Color3.fromRGB(50, 15, 100)
Credits.Text = "Edited by Anya"
			for i,v in pairs(Holder:GetDescendants()) do
				if v:IsA("Frame") or v:IsA("TextLabel") or v:IsA("TextButton") then 
				    v.BackgroundColor3 = Color3.fromRGB(50, 15, 100)
